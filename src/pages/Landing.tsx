...
export default function Landing() {
  ...
  const slime = useMemo(() => TEMPLATES.find((template) => template.id === 'slime')!.build(), []);
  const knight = useMemo(() => TEMPLATES.find((template) => template.id === 'knight')!.build(), []);
  const coin = useMemo(() => TEMPLATES.find((template) => template.id === 'coin')!.build(), []);
  const ghost = useMemo(() => TEMPLATES.find((template) => template.id === 'ghost')!.build(), []);

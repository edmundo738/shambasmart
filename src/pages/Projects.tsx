    ...
    >
      ...
      <div className="p-3">
        <div className="flex items-center gap-2">
          ...
          {tpl.tags.includes('angola') && <span className="rounded border border-ember-400/40 px-1.5 py-0.5 text-[9px] font-bold uppercase tracking-wide text-ember-400">Angola · 2D</span>}
        </div>

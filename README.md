...
- **Modelos prontos** — slime, cavaleiro, moeda, fantasma e estudos 2D de Angola: imbondeiro, palanca negra gigante, candongueiro e pessoa angolana
...
- **Gerador de Sprites** (`/gerador`) — para quem não sabe desenhar: 5 categorias (personagem, criatura, arma, item, efeito), 7 estilos visuais incluindo Angola, seed reproduzível, prévia animada e receita (`AssetRecipe`) que regenera o mesmo asset sempre; cria no Studio ou baixa o pack ZIP direto
